...
const PaymentSelectionScreen: React.FC<PaymentSelectionScreenProps> = ({
  ...
  const details = [
    ...
    {
      label: "Tip",
      value: `$${tipPercentage * 0.01 * route.params.selectedService.price}`,
    },
    { label: "Taxes", value: "$5" },
    {
      label: "Total",
      value: `$${
        route.params.selectedService.price +
        tipPercentage * 0.01 * route.params.selectedService.price +
        5
      }`,
      isBold: true,
    },
  ...
  return (
    <StripeProvider publishableKey="pk_test_51OCCJMKcvvxOFlJyWqW2gDBZTBBl2MGKfrG52NVl2of5jU6RXpUBukxEe7mgxZc2tplTwKDzgH33UASoF0yuJDdt00ZA9WiHqM">
